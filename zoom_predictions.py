...
def run_blob_classifier(indir):
	...
	for filename in glob.iglob('{}/*{}'.format(indir,extensions)):
		...
		predicted_label = get_predicted_label(probability)
            ...
            print 'Probability: Worm {:.2f}, Spot {:.2f}, Track {:.2f}'.format(*probability)
            print predicted_label

if __name__ == '__main__':
    #run_blob_classifier(indir='/home/mwinter/DECO/sortedEvents/track')
    run_blob_classifier(indir='./sortedEvents/track')
